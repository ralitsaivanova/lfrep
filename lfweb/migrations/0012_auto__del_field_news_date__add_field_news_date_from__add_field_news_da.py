...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'lfweb_news', 'date')

        # Adding field 'News.date_from'
        db.add_column(u'lfweb_news', 'date_from',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'News.date_to'
        db.add_column(u'lfweb_news', 'date_to',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'lfweb_news', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'News.date_from'
        db.delete_column(u'lfweb_news', 'date_from')

        # Deleting field 'News.date_to'
        db.delete_column(u'lfweb_news', 'date_to')
