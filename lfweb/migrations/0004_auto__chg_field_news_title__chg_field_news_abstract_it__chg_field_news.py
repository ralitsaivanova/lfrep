...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lfweb_news', 'title', self.gf('django.db.models.fields.CharField')(max_length=130, null=True))

        # Changing field 'News.abstract_it'
        db.alter_column(u'lfweb_news', 'abstract_it', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'News.title_en'
        db.alter_column(u'lfweb_news', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=130, null=True))

        # Changing field 'News.abstract'
        db.alter_column(u'lfweb_news', 'abstract', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'News.title_it'
        db.alter_column(u'lfweb_news', 'title_it', self.gf('django.db.models.fields.CharField')(max_length=130, null=True))

        # Changing field 'News.abstract_en'
        db.alter_column(u'lfweb_news', 'abstract_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'News.title'
        db.alter_column(u'lfweb_news', 'title', self.gf('tinymce.models.HTMLField')(max_length=130, null=True))

        # Changing field 'News.abstract_it'
        db.alter_column(u'lfweb_news', 'abstract_it', self.gf('tinymce.models.HTMLField')(max_length=255, null=True))

        # Changing field 'News.title_en'
        db.alter_column(u'lfweb_news', 'title_en', self.gf('tinymce.models.HTMLField')(max_length=130, null=True))

        # Changing field 'News.abstract'
        db.alter_column(u'lfweb_news', 'abstract', self.gf('tinymce.models.HTMLField')(max_length=255, null=True))

        # Changing field 'News.title_it'
        db.alter_column(u'lfweb_news', 'title_it', self.gf('tinymce.models.HTMLField')(max_length=130, null=True))

        # Changing field 'News.abstract_en'
        db.alter_column(u'lfweb_news', 'abstract_en', self.gf('tinymce.models.HTMLField')(max_length=255, null=True))
