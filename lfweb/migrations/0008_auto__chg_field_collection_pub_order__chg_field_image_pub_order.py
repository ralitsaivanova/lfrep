...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.pub_order'
        db.alter_column(u'lfweb_collection', 'pub_order', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'Image.pub_order'
        db.alter_column(u'lfweb_image', 'pub_order', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Collection.pub_order'
        db.alter_column(u'lfweb_collection', 'pub_order', self.gf('django.db.models.fields.SmallIntegerField')(default=''))

        # Changing field 'Image.pub_order'
        db.alter_column(u'lfweb_image', 'pub_order', self.gf('django.db.models.fields.SmallIntegerField')(default=1))
