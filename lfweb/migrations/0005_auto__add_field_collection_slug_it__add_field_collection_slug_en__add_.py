...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.slug_it'
        db.add_column(u'lfweb_collection', 'slug_it',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Collection.slug_en'
        db.add_column(u'lfweb_collection', 'slug_en',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Collection.description_it'
        db.add_column(u'lfweb_collection', 'description_it',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Collection.description_en'
        db.add_column(u'lfweb_collection', 'description_en',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.slug_it'
        db.delete_column(u'lfweb_collection', 'slug_it')

        # Deleting field 'Collection.slug_en'
        db.delete_column(u'lfweb_collection', 'slug_en')

        # Deleting field 'Collection.description_it'
        db.delete_column(u'lfweb_collection', 'description_it')

        # Deleting field 'Collection.description_en'
        db.delete_column(u'lfweb_collection', 'description_en')
